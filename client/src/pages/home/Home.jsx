...
export default function Home() {
    // Obtener el numero total de administraciones dentro de la base de datos
    const [total, setTotal] = useState(0);
    const [loading, setLoading] = useState(true);
    const [error, setError] = useState(null);

    useEffect(() => {
        fetch("http://localhost:8000/administracion/count-all")
        .then(res => res.json())
    ...
    if (loading) return <p>Cargando total...</p>;
                ...
                <div className="half_second">
                    <div className="image-container">
                        ...
                        <div className="floating-label">
                            ...
                            <span className="main-title"><strong>{`${total} traspasos`}</strong></span>
                            </div>
                        </div>
                    </div>
                </div>
